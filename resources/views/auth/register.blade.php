...
<head>
    ...
    <title>Register - TRIP Smartly</title>
...
<body class="bg-gray-100 min-h-screen flex items-center justify-center p-4">
    <div class="bg-white rounded-lg shadow-xl p-6 w-full max-w-md">
        ...
        <div class="mb-8 text-center">
            ...
            <p class="text-gray-600 mt-2">Enter your details to sign up</p>
        </div>
        ...
        <form action="{{ route('register') }}" method="POST">
            ...
            <div class="space-y-4">
                <!-- Fullname -->
                <div>
                    <label for="name" class="block text-sm font-medium text-gray-700 mb-1">Fullname</label>
                    <div class="relative">
