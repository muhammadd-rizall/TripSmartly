<header class="flex flex-wrap sm:justify-start sm:flex-nowrap w-full bg-white shadow text-sm py-3 fixed top-0 z-50">
  ...
  <nav class="max-w-[85rem] w-full mx-auto px-4 flex flex-wrap basis-full items-center justify-between">
    ...
    <!-- Logo -->
    <a
      class="sm:order-1 flex-none text-xl font-bold text-blue-500 hover:text-yellow-400 transition"
      href="#">
      TRIp Smartly
    </a>
    ...
    <div class="sm:order-3 flex items-center gap-x-2">
      ...
      <button type="button"
        ...
        <!-- Icon Close -->
        <svg class="hs-collapse-open:block hidden shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" fill="none"
          viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
          <path d="M18 6 6 18" />
          <path d="m6 6 12 12" />
        </svg>
    ...
    <div
      ...
      <div class="flex flex-col gap-5 mt-5 sm:flex-row sm:items-center sm:mt-0 sm:ps-5">
        <a class="font-bold text-blue-500 hover:text-yellow-400 transition" href="#" aria-current="page">Home</a>
        <a class="font-bold text-blue-500 hover:text-yellow-400 transition" href="#">Rooms</a>
        <a class="font-bold text-blue-500 hover:text-yellow-400 transition" href="#">Amenities</a>
        <a class="font-bold text-blue-500 hover:text-yellow-400 transition" href="#">Contact</a>
      </div>
    </div>
  </nav>
</header>
