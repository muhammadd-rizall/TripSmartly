        ...
        <div class="sm:order-3 flex items-center gap-x-2">
            ...
            <div id="hs-navbar-alignment"
                ...
                <div class="flex flex-col gap-5 mt-5 sm:flex-row sm:items-center sm:mt-0 sm:ps-5">
                    <a class="font-bold text-blue-500 hover:text-yellow-400 transition" href="#"
                        aria-current="page">Home</a>
                    <a class="font-bold text-blue-500 hover:text-yellow-400 transition" href="#">Open Trip</a>
                    <a class="font-bold text-blue-500 hover:text-yellow-400 transition" href="#">Rental Barang</a>
                    <a class="font-bold text-blue-500 hover:text-yellow-400 transition" href="#"></a>
                </div>
            </div>
        @endauth
    </nav>
