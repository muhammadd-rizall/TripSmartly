                    ...
                    <div class="card-body">
                        ...
                        <form action="/inputTD" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="places" id="places" class="form-control" rows="5" required></textarea><small>pisah dengan koma</small>
                            </div>

                            {{-- Deskripsi --}}
                            <div class="mb-3">
                                <label for="description" class="form-label">Deskripsi</label>
                                <textarea name="description" id="description" class="form-control" rows="3" required></textarea><small>pisah dengan koma</small>
                            </div>
